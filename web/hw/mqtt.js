...
$(document).ready(function() {
  ...
  function mqtt() {
    ...
    function onMessageArrived(message) {
      ...
      if (message.destinationName === '/weather') {
        ...
        $('#weatherResult').html(msg.resultTranscript);
      ...
      if (message.destinationName === '/bus') {
        var msg = JSON.parse(message.payloadString)
     ...
     // news가 올때 html에 있던 text empty
      ...
      if (message.destinationName === '/news') {
       ...
       $('#newsResult').html(msg.resultTranscript);
  ...
  if (message.destinationName === '/blog') {
   ...
   $('#blogResult').html(msg.resultTranscript);
  ...
  if (message.destinationName === '/list') {
   ...
   $('#list5').html('뉴스');
   $('#list5-1').html(' "뉴스 알려줘" ');
   $('#listResult').html(msg.resultTranscript);
  }
